...
% Function to translate a word between a foreign language and English using a given dictionary.
...
% Function to translate a list of words between a foreign language and English using a given dictionary.
...
% Function to build a dictionary from two corresponding lists of foreign and English words.
dictionary_build([],[],[]).
...
% Function to translate a word to/from English based on a chosen language using the hand-built dictionaries.
...
% Function to translate a list of words to/from English based on a chosen language using the hand-built dictionaries.
...
% Function to translate a word to/from English using the hand-built dictionaries if a translation is found, otherwise uses '?' as the translation.
...
% Function to start translating a word to/from a specific language if a translation can be found, otherwise uses '?' as the translation.
...
% Function to translate a list of words to/from English based on a chosen language using the hand-built dictionaries if a translation is found, otherwise uses '?' as the translation.
